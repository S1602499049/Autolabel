...
class Detector():
    ...
    def work(self):
        with open(self.detect_class, "r") as f:  
                ...
                try:
                    ...
                    if coordinates_list:
                        ...
                        for coordinate in coordinates_list:
                            ...
                            print("label_id 的值为:", label_id) 
                            print("self.predefined_classes 的内容为:", self.predefined_classes) 
                            print("self.predefined_classes 的长度为:", len(self.predefined_classes)) 
                    ...
                    print(f"处理图片 {image_name} 时出现问题，跳过: {e}")
                    continue
    # 客户端
    def client(self):
        def creatWindow():
